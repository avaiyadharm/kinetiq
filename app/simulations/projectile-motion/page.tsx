...
import { TheoreticalBasis } from "@/components/simulations/TheoreticalBasis";
import { UserGuide } from "@/components/simulations/UserGuide";
import { TabType } from "@/components/simulations/SimulationPageLayout";
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#09090b]">
            ...
            <div className="h-[40%] border-t border-white/5 bg-black p-8 grid grid-cols-1 md:grid-cols-3 gap-8 overflow-y-auto">
              ...
              <section className="bg-[#09090b] rounded-2xl p-6 border border-white/5 flex flex-col h-full relative overflow-hidden">
                 ...
                 <div className="flex-1 overflow-y-auto space-y-3 font-mono text-[11px] text-primary/70 scrollbar-hide">
                   <p className="flex gap-2"><span className="opacity-40">08:30:12</span> <span className="text-success">OK</span> Gravity vector locked: {gravity} m/s²</p>
        ...
        {activeTab === "config" && (
          <div className="flex-1 overflow-y-auto p-12 bg-[#09090b]">
             <div className="max-w-2xl mx-auto bg-[#18181b] rounded-3xl border border-white/5 p-10 shadow-2xl">
        ...
        {activeTab === "theory" && <TheoreticalBasis />}
